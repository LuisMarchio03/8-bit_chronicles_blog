...
export default function Home() {
  ...
  return (
    <div>
      <h2 className="text-2xl font-pixel mb-6">Latest 8-Bit Adventures</h2>
            ...
            {posts
              ...
              .map((post) => (
                <Link
                  key={post.id}
                  href={`/post/${post.id}`}
                  className="block p-6 bg-gray-900 rounded-lg hover:bg-gray-800 transition-colors h-48 flex flex-col justify-between"
                >
